...
var SVEClassificator = /** @class */ (function () {
    ...
    SVEClassificator.classify = function (model, data, className) {
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAIRoot() + '/model/' + model + "/classify", {
                method: 'PUT',
                headers: {
    ...
    SVEClassificator.issueRelearn = function (model, forceNew) {
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAIRoot() + '/model/' + model + ((forceNew) ? "/retrain" : "/train"), {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    SVEClassificator.getClasses = function (model) {
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAIRoot() + "/model/" + model + "/classes", {
                method: "GET"
            }).then(function (response) {
                if (response.status < 400) {

...
var SVEData = /** @class */ (function () {
    ...
    function SVEData(handler, initInfo, onComplete) {
        ...
        if (typeof initInfo === "number") {
            ...
            if (typeof SVESystemInfo_1.SVESystemInfo.getInstance().sources.sveService !== undefined && !SVESystemInfo_1.SVESystemInfo.getIsServer()) {
                try {
                    fetch(SVESystemInfo_1.SVESystemInfo.getInstance().sources.sveService + '/data/' + this.id, {
                        method: 'GET',
                        headers: {
                        ...
                        if (response.status < 400) {
                            response.json().then(function (val) {
                                ...
                                _this.name = val.name;
                                new SVEProject_1.SVEProject(Number(val.project), _this.handler, function (prj) {
    ...
    SVEData.prototype.pullClassification = function () {
        ...
        return new Promise(function (resolve, reject) {
            if (SVESystemInfo_1.SVESystemInfo.getInstance().sources.aiService !== undefined) {
                fetch(SVESystemInfo_1.SVESystemInfo.getInstance().sources.aiService + '/model/documents/class', {
                    method: 'GET',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
    ...
    SVEData.getLatestUpload = function (user) {
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAPIRoot() + "/data/latest", {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                ...
                if (response.status < 400) {
                    response.json().then(function (val) {
                        if (val.project !== undefined) {
                            new SVEProject_1.SVEProject(Number(val.project), user, function (prj) {
                                new SVEData(user, {
    ...
    SVEData.prototype.getURI = function (version, download) {
        ...
        return (SVESystemInfo_1.SVESystemInfo.getAPIRoot() + "/project/" + this.parentProject.getID() + "/data/" + this.id + "/") + ((download) ? "download" : ((SVEDataVersion.Full === version) ? "full" : "preview"));
    };

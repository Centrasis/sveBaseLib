...
var SVEProject = /** @class */ (function () {
    function SVEProject(idx, handler, onReady) {
        ...
        if (!isProjectInitializer(idx)) {
            if (SVESystemInfo_1.SVESystemInfo.getIsServer()) {
                ...
                fetch(SVESystemInfo_1.SVESystemInfo.getAPIRoot() + '/project/' + idx + "?sessionID=" + encodeURI(this.handler.getSessionID()), {
                    method: 'GET',
                    headers: {
    ...
    SVEProject.prototype.getResult = function () {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.result === undefined) {
                ...
                new SVEData_1.SVEData(_this.handler, _this.result, function (data) {
                    resolve(data);
                });
            }
        });
    ...
    SVEProject.prototype.store = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAPIRoot() + '/project/' + ((!isNaN(_this.id)) ? _this.id : "new") + "?sessionID=" + encodeURI(_this.handler.getSessionID()), {
                method: 'PUT',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    SVEProject.prototype.remove = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAPIRoot() + '/project/' + _this.id + "?sessionID=" + encodeURI(_this.handler.getSessionID()), {
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    SVEProject.prototype.getData = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            fetch(SVESystemInfo_1.SVESystemInfo.getAPIRoot() + '/project/' + _this.id + '/data?sessionID=' + encodeURI(_this.handler.getSessionID()), {
                method: "GET",
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
